<?php
	...
	if ($senhaUsuario != $confirmarSenhaUsuario) {
		...
		header("refresh:0.1; url= https://hairexe.000webhostapp.com/cadastro_usuario.php");
	}
	...
	if ($verificaCpf > 0){
		...
		if (isset($nomeUsuario) && isset($cpfUsuario) && isset($emailUsuario) && isset($telefoneUsuario) && isset($senhaUsuario)) {
			...
			$sql = "INSERT INTO cadastro_usuario (nome_usuario,cpf_usuario,email_usuario,telefone_usuario,senha_usuario) VALUES ('$nomeUsuario', '$cpfUsuario','$emailUsuario', '$telefoneUsuario', '$senhaUsuario')";
			...
			echo "<script>alert('Cadastro efetuado com sucesso!'); window.location='https://hairexe.000webhostapp.com/login_usuario.php'; </script>";
			//header("refresh:0.1; url=https://hairexe.000webhostapp.com/login_usuario.php");
		}
	}
