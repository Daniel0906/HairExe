<?php
	...
	if ($senhaUsuario != $confirmarSenhaUsuario) {
		...
		header("refresh:0.1; url= cadastro_usuario.php");
	}
	...
	if ($verificaCpf > 0){
		...
		if (isset($nomeUsuario) && isset($cpfUsuario) && isset($emailUsuario) && isset($telefoneUsuario) && isset($senhaUsuario)) {
			...
			$sql = "INSERT INTO cadastro_usuario (id_usuario,nome_usuario,cpf_usuario,email_usuario,telefone_usuario,senha_usuario) VALUES ('', '$nomeUsuario', '$cpfUsuario','$emailUsuario', '$telefoneUsuario', '$senhaUsuario')";
			...
			header("refresh:0.1; url= login_usuario.php");
		}
	}
